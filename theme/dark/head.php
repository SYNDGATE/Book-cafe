...
<section id="topbar" class="bg-indigo-500 text-white py-2 text-base">
  <div class="container mx-auto flex justify-between px-2 lg:px-0">
    <div class="hidden lg:block">
      <i class="bi bi-envelope inline-flex items-center"><a href="mailto:<?php echo $config['cf_admin_email']?>"><span class="pl-1"><?php echo $config['cf_admin_email']?></span></a></i>
      <i class="bi bi-phone inline-flex items-center ml-4"><span> <?php echo $config['cf_1']?></span></i>
    </div>
